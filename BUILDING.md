...
This guide provides detailed instructions for building HoAh from source.
...
The easiest way to build HoAh is using the included Makefile, which automates the entire build process including building and linking the whisper framework.

### Simple Build Commands

```bash
# Clone the repository
git clone https://github.com/yangzichao/hoah-dictation.git
cd hoah-dictation
...
- `make build` - Build the HoAh Xcode project
- `make run` - Launch the built HoAh app
...
1. **Manages Dependencies**: Creates a dedicated `~/HoAh-Dependencies` directory for all external frameworks
...
For more help, please check the [issues](https://github.com/yangzichao/hoah-dictation/issues) section or create a new issue. 
