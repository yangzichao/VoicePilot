...
### 示例：职场模式 (Professional Mode)
**语音输入 (Raw)**：
> “哎，今天这活儿我干不了。客户太烦人了，一直改主意。最后没按期完成又不怪我。”

**润色后 (Polish)**：
> “今天我无法完成这项工作。客户反复修改需求，所以没能按时完成并不是我的错。”
> *（虽然通顺，但依然生硬）*

**职场模式 (Professional)**：
> “由于客户近期对需求进行了调整，我今天可能无法完成该任务。鉴于这些变动，建议我们重新评估项目时间表，以确保最终交付符合预期。”
> *（委婉、专业、以解决问题为导向）*
